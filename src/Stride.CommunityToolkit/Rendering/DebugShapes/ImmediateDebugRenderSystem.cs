...
public class ImmediateDebugRenderSystem : GameSystemBase
{
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        for (int i = 0; i < _renderMessagesWithLifetime.Count; ++i)
        {
            var renderMessageWithLifetime = _renderMessagesWithLifetime[i];
            renderMessageWithLifetime.Lifetime -= delta;
            _renderMessagesWithLifetime[i] = renderMessageWithLifetime;
        }
